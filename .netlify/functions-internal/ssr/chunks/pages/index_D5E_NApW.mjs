...
import { a as $$Image, $ as $$Layout } from './_id__B1jMEGCB.mjs';
/* empty css                          */
...
</p> </div> ${renderComponent($$result, "Image", $$Image, { "class": "text-white bg-white rounded-full lg:mx-0 md:mx-0 mx-auto mt-5 lg:mt-0", "loading": "lazy", "format": "png", "width": 150, "height": 150, "src": "/logo.webp", "alt": "Logo Suplementos" })} </div> </header>`;
